...
$$d S_t=\mu S_t d t+f\left(v_t\right) S_t^{\frac{\theta}{2}} d W_{1, t}^{\mathbb{P}}$$    
$$d v_t=\alpha\left(m-v_t\right) d t+\beta d W_{2, t}^{\mathbb{P}}$$  
$$\rho d t=d W_{1, t}^{\mathbb{P}} d W_{2, t}^{\mathbb{P}}$$
In terms of the instantaneous correlation coefficient $\rho$, we write
